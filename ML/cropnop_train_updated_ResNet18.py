...
class CustomDataset(Dataset):
  ...
  def log_image_table(images, predicted, labels, probs):
    ...
    table = wandb.Table(columns=["image", "pred", "target"]+[f"score_{i}" for i in range(25)])
...
DATA_DIR='/home/kjawanja/Crop_Nop_Final/cropornop(new-v3)/'
MODEL_DIR='/home/kjawanja/models/CropOrNop(ResNet-1)/'
...
#model.classifier = torch.nn.Sequential(nn.Flatten(),nn.Linear(10,1))
